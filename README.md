...
## 🚀 About Me
I love strengthening systems, understanding attacks, and studying how adversaries think.  
My long-term aim is to excel in purple teaming blending detection, defense, and offensive knowledge to build stronger security environments.
...
- SIEM (Splunk, Wazuh)  
- Wireshark, Sysmon, Procmon  
- ELK Stack  
- Basic malware analysis tools  


**Operating Systems**  
- Windows (defense + analysis)  
...
<p align="left">
  ...
  </a> <a href="https://developer.mozilla.org/en-US/docs/Web/tailwind" target="_blank" rel="noreferrer"> <img src="https://skillicons.dev/icons?i=tailwind" alt="tailwind" width="40" height="40"/> </a>
